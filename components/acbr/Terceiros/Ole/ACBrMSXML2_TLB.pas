...
// *********************************************************************//
  IXMLDigitalSignatureEx = interface(IXMLDigitalSignature)
    ...
    function createKeyFromCertContext(pCertContext: Pointer; out keyRef: IXMLDSigKeyEx): HResult; stdcall;
    ...
    function setStoreHandle(hCertStore: Pointer): HResult; stdcall;
...
// *********************************************************************//
  ...
  public
    ...
    procedure setProperty(const Aname: WideString; value: OleVariant);
    function getProperty(const Aname: WideString): OleVariant;
...
begin
  Result := DefaultInterface.schemas;
end;

procedure TmsDOMDocument._Set_schemas(otherCollection: OleVariant);
begin
  DefaultInterface.schemas := otherCollection;
end;
...
procedure TmsDOMDocument.setProperty(const Aname: WideString; value: OleVariant);
begin
  DefaultInterface.setProperty(Aname, value);
end;

function TmsDOMDocument.getProperty(const Aname: WideString): OleVariant;
begin
  Result := DefaultInterface.getProperty(Aname);
end;
...
procedure TmsDOMDocument26.setProperty(const Aname: WideString; value: OleVariant);
begin
  DefaultInterface.setProperty(Aname, value);
end;

function TmsDOMDocument26.getProperty(const Aname: WideString): OleVariant;
begin
  Result := DefaultInterface.getProperty(Aname);
end;
...
procedure TmsDOMDocument30.setProperty(const Aname: WideString; value: OleVariant);
begin
  DefaultInterface.setProperty(Aname, value);
end;

function TmsDOMDocument30.getProperty(const Aname: WideString): OleVariant;
begin
  Result := DefaultInterface.getProperty(Aname);
end;
...
procedure TDOMDocument40.setProperty(const Aname: WideString; value: OleVariant);
begin
  DefaultInterface.setProperty(Aname, value);
end;

function TDOMDocument40.getProperty(const Aname: WideString): OleVariant;
begin
  Result := DefaultInterface.getProperty(Aname);
end;
...
procedure TmsFreeThreadedDOMDocument.setProperty(const Aname: WideString; value: OleVariant);
begin
  DefaultInterface.setProperty(Aname, value);
end;

function TmsFreeThreadedDOMDocument.getProperty(const Aname: WideString): OleVariant;
begin
  Result := DefaultInterface.getProperty(Aname);
end;
...
procedure TmsFreeThreadedDOMDocument26.setProperty(const Aname: WideString; value: OleVariant);
begin
  DefaultInterface.setProperty(Aname, value);
end;

function TmsFreeThreadedDOMDocument26.getProperty(const Aname: WideString): OleVariant;
begin
  Result := DefaultInterface.getProperty(Aname);
end;
...
procedure TmsFreeThreadedDOMDocument30.setProperty(const Aname: WideString; value: OleVariant);
begin
  DefaultInterface.setProperty(Aname, value);
end;

function TmsFreeThreadedDOMDocument30.getProperty(const Aname: WideString): OleVariant;
begin
  Result := DefaultInterface.getProperty(Aname);
end;
...
procedure TFreeThreadedDOMDocument40.setProperty(const Aname: WideString; value: OleVariant);
begin
  DefaultInterface.setProperty(Aname, value);
end;

function TFreeThreadedDOMDocument40.getProperty(const Aname: WideString): OleVariant;
begin
  Result := DefaultInterface.getProperty(Aname);
end;
...
begin
  DefaultInterface.signature := signatureNode;
end;
