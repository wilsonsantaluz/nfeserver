...
var handleCheckPageLoadUrl = function (hash) {
    hash = (hash) ? hash : '#ajax/nfe_dashboard.html';
...
var handleCheckPageLoadUrlfull = function (hash, apage) {
    hash = (hash) ? hash : apage;
...
var handleSidebarAjaxClick = function () {
    $('.sidebar [data-click=ajax]').click(function () {
        var targetLi = $(this).closest('li');
...
var setactive =  function (omenu) {
    var targetLi = $(omenu).closest('li');
    var targetParentLi = $(omenu).parents();
    $('.sidebar li').not(targetLi).not(targetParentLi).removeClass('active');
    $(targetLi).addClass('active');
    $(targetParentLi).addClass('active');
};
...
var handleMobileSidebar = function () {
    ...
    $('.page-sidebar-minified .sidebar [data-scrollbar=true] a').bind('touchend', function (e) {
        ...
        if (finalHeight >= sidebarHeight && windowHeight <= sidebarHeight && sidebarContainerHeight <= sidebarHeight) {
            ...
            $(targetScrollBar).animate({
                marginTop: finalMargin + 'px'
            });
...
var handleMenus = function () {
    ...
    $(document).on('click', '[data-click="configuracoes"]', function () {
       
        handleCheckPageLoadUrlfull(window.location.hash, '#ajax/nfe_configuracoes.html');
        setactive(this);
    });

    $(document).on('click', '[data-click="dashboard"]', function () {
        handleCheckPageLoadUrlfull(window.location.hash, '#ajax/nfe_dashboard.html');
        setactive(this);
    });

    $(document).on('click', '[data-click="nfecanceladas"]', function () {
        handleCheckPageLoadUrlfull(window.location.hash, '#ajax/nfe_cancelamentos.html');
        setactive(this);
    });
    ...
    $(document).on('click', '[data-click="nfeinutilizadas"]', function () {
